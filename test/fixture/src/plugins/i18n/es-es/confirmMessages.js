const confirmMessages = {
    ...
    changeEscritoType: 'Perderá la información con la referencia del código de barras del Acuse. ¿Desea continuar?',
    ...
    confirmBorrarRecurso: 'Se han producido modificaciones,<br>¿Realmente desea eliminar la información especificada?',
    ...
    confirmForbiddenRevision: 'La Personación no está en situación de modificación ¿Desea consultarla?',
    ...
    inicializarCargasClaseReparto: '¿Está seguro de inicializar las cargas de la Clase de Reparto "{codigo}"?',
    mantenerCambiarEstado: 'No ha seleccionado cambiar el estado a {estado}. ¿Desea mantener o cambiar el estado?',
    ...
    newProcedimientoConfirm: `{campo}<br/><br/>
                      ...
                      {ngeneral}<br/>
                      {nuevoCampo}`,
    ningunOrganoSeleccionado: 'Si no se selecciona ningún Organo la asignación será extensiva a todos.¿Continuar?',
    ...
    printMultipleFilterConfirm: `El número de resultados es muy alto, esta operación puede tardar varios minutos.<br/>
                              ¿Desea continuar?`,
    procedimientoNoEditable: 'Este procedimiento no está en situación de modificación ¿Desea consultarlo?',
