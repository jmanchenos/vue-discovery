const notifyMessages = {
  ...
  actualizaEstadoAcontecimiento:
    'Se ha actualizado el estado de cumplimentación en 1 acontecimiento, ',
  actualizaEstadosAcontecimientos:
    'Se ha actualizado el estado de cumplimentación en {n1} acontecimientos, ',
  ...
  msgAsigClaseRepartoParticular:
    '¿Asignar la Clase {coClaseRep} a algún/os Órgano/s en particular ?',
  ...
  msgModificarAsigOrganosAdscritos:
    '¿Modificar la asignación de clase {coClaseRep} a los órganos adscritos?',
  msgOkActualizadosAgenda:
    '{procedimiento} acont. {acont}: Se ha actualizado el estado apuntes agenda del procedimiento.',
  msgSinPermisoSecretoSumario:
    'Procedimiento en Secreto de Actuaciones, no tiene los permisos requeridos',
  ...
  noCoincideDelitoOrigen:
    'El delito/materia introducido no coincide con el del procedimiento origen: {delito}',
