export class Parser {
  ...
  static startAtAndGetPositionOfStartAndEnd(content, search, start, end) {
    ...
    return {
      ...
      ...Parser.getPositionOfStartAndEnd(contentAtStart, start, end),
    };
  }
  /**
   * Devuelve el contenido de un atributo en formato objeto
  ...
  /**
   * Devuelve el contenido de un atributo en formato array
   * @param {String} attribute
   * @returns {Array}
   * */
  ...
  props() {
    ...
    if (props) {
      try {
        ...
        console.error('Error en props:', e);
      }
      return this;
    } else {
  ...
  script() {
    ...
    // Para los componentes que vienen ya compilados todo el contenido es el  script
    if (!content || !start || !end) {
      this.parsed.script = this.content;
    } else {
  ...
  static parseObjectJS(inputString) {
    ...
    if (inputString.startsWith(`{`)) {
      try {
        ...
        console.error('Error en parseObjectJS:', error);
        result = null;
      }
    }
    return result;
